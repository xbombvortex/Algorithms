...
function Sprite(pInst, _x, _y, _w, _h) {
  ...
  */
   ...
   * @method _collideWith
   * @private
   * @param {string} type - 'overlap', 'bouceOff', 'displace', 'collide',
   *   'bounce' or 'bounceOff'
   * @param {Sprite|Group} target
   * @param {function} callback - if collision occurred (ignored for 'bouceOff')
  ...
  this._collideWithOne = function(type, other, callback) {
    ...
    // Finally, for all collision types except 'bouceOff', call the callback
    // and record that collision occurred.
    if (typeof callback === 'function' && type !== 'bouceOff') {
